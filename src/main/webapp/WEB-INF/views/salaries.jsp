...
<!------ Head ---------->
<head>
    <title>Liste des salaries</title>
    <meta charset="utf-8">
...
<table class="table table-striped">
    ...
    <tr>
        ...
        <td><a class="glyphicon glyphicon-pencil" href="update.html?id=${salarie.id}"></td>
        ...
        <td><a class="glyphicon glyphicon-trash" href="delete.html?id=${salarie.id}"></td>
