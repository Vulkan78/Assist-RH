    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="padding-bottom:0.05em;">
                <div class="btn-group" role="group"><a class="btn btn-outline-dark info-tab" role="button" href="mg-salaries.html">Salariés</a><a class="btn btn-dark info-tab current" role="button" href="#" style="margin-right:0.1em;margin-left:0.1em;">Demande en cours</a>
                    <a
                            class="btn btn-outline-dark info-tab" role="button" href="mg-historique.html" style="margin-left:0px;">Historique</a>
                </div>
            </div>
        </div>
    </div>
                        ...
                        <table class="table table-striped table-dark">
                            ...
                            <c:forEach items="${formationPersonneListStatut}" var="formationPersonneListStatut">
                                <tr>
                                    ...
                                    <td><a href="mg-detail.html?id=${formationPersonneListStatut.id}"><i class="fa fa-external-link-square fa-lg"></i></a></td>
                                </tr>
                            </c:forEach>
                            </tbody>
                        </table>
