        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12" style="padding-bottom:0.05em;">
                    <div class="btn-group" role="group"><a class="btn btn-dark info-tab current" role="button" href="#">Catalogue</a><a class="btn btn-outline-dark info-tab" role="button" href="formation-demandes.html" style="margin-right:0.1em;margin-left:0.1em;">Demande en cours</a>
                        <a
                            ...
                            <table class="table table-striped table-dark">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="catalogue-detail.html?id=${formation.id}"><i class="fa fa-external-link-square fa-lg"></i></a></td>
                                    </tr>
                                  </c:forEach>
                                </tbody>
                            </table>
