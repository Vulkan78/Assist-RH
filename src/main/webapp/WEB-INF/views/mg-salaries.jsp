    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="padding-bottom:0.05em;">
                <div class="btn-group" role="group"><a class="btn btn-dark info-tab current" role="button" href="#">Salariés</a><a class="btn btn-outline-dark info-tab" role="button" href="mg-demandes.html" style="margin-right:0.1em;margin-left:0.1em;">Demande en cours</a>
                    <a
                ...
                <form method="post" action="search.html">
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-dark">
                            ...
                            <tbody>
                            <c:forEach items="${salarieList}" var="salarie">
                                <tr>
                                    <td>${salarie.id}</td>
                                    <td>${salarie.nom}</td>
